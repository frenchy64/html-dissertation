...
include variables \x{}, values \val{},
...
\begin{figure}
  ...
  \begin{altgrammar}
    ...
    \val{} &::=& \ldots \alt {\classvalue{\classhint{}} {\overrightarrow {\classfieldpair{\fld{}} {\val{}}}}}
    &\mbox{Values} \\
...
\begin{altgrammar}
  ...
  \val{} &::=& \ldots \alt {\multi {\val{}} {\disptable{}}}
                &\mbox{Values} \\
 \disptablesyntax{} \\
...
%The value {\multi {\val{}} {\disptable{}}} is the runtime value of a multimethod
%with dispatch function {\val{}} and dispatch table {\disptable{}}.
%
...
First the dispatch function \val{d} is applied to the argument \vp{} to obtain
the dispatch value \val{e}.
Based on \val{e},
the \getmethodliteral{} metafunction (\figref{main:figure:mmsyntax})
extracts a method \val{f} from the method table {\disptable{}}
...
ranges over the runtime value of maps {\curlymapvaloverright{\kw{}}{\val{}}},
usually written {\curlymapvaloverrightnoarrow{\kw{}}{\val{}}}.
